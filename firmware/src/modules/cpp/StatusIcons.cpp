...
// Bluetooth icon bitmaps (14x16 pixels)
static const unsigned char PROGMEM bluetooth_disconnected_bits[] = {
  0xfd,0xfc,0x7c,0xfc,0xbd,0x7c,0xdd,0xbc,0xed,0xdc,0xf7,0xdc,0xfb,0xbc,0xfd,
  0xfc,0xfa,0xfc,0xf5,0x7c,0xed,0xbc,0xdd,0xdc,0xfd,0xac,0xfd,0x74,0xfe,0xf8,
  0xff,0xfc
};

static const unsigned char PROGMEM bluetooth_connected_bits[] = {
  0xfe,0xfc,0xfd,0x7c,0xfd,0xbc,0xdd,0xdc,0xed,0xdc,0xb5,0xb4,0xd9,0x6c,0xcc,
  0xcc,0xd9,0x6c,0xb5,0xb4,0xed,0xdc,0xdd,0xdc,0xfd,0xbc,0xfd,0x7c,0xfe,0xfc,
  0xff,0xfc
};
...
void StatusIconsDrawBluetooth(int16_t x, int16_t y, bool connected) {
  Adafruit_SSD1306& display = DisplayGetDisplay();
  const unsigned char* bitmap = connected ? bluetooth_connected_bits : bluetooth_disconnected_bits;
  display.drawBitmap(x, y, bitmap, BLUETOOTH_ICON_WIDTH, BLUETOOTH_ICON_HEIGHT, 1);
}
